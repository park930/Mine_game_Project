package MineGame;// enjoy submarine detection game
...
//            send("Wait for other player..");
		...
		public String getStatistics() {
			return "total:"+ total+" win:"+win+" lose:"+lose;
		}
			...
			switch (command) {
				...
				case "startGame":
					...
					if(checkGameReady(gameClientList,targetRoom)){
						...
						findRoomById(targetRoom.getId(),roomList).setStart(true);
		...
		public String toString() {
			String res =  "ID:"+getId()+"    Name:"+userName;
			return res;
		}
