...
public class InGameUserPanel extends JPanel {
    ...
    public InGameUserPanel(User user) {
    	...
    	userIconLabel.setIcon(new ImageIcon((new ImageIcon(InGameUserPanel.class.getResource("/mineGame/Screen/icon/person.png"))).getImage().getScaledInstance(39, 39, Image.SCALE_SMOOTH)));
